...
for j in range(3,19):      
    ...
    path = "log{}.txt".format(j,numNodes) 
    #network parameters   
    ...
    Tx_try_per_node = [0 for i in range(0,aux_numNode)] # pacotes que foram enviados
    ...
    with open(path,'r') as f:
        ...
        prr = Tx_total - Rx_total # pacotes perdidos 
        prr = prr/Tx_total # pacotes perdidos  
